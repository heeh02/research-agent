...
This project is a **multi-agent automated research system** where each role runs as a separate Codex / Codex process.
...
│
├── Codex -p (Researcher Agent)     ← agents/researcher/AGENTS.md
│   Tools: Read, Write, Glob, Grep, WebSearch, WebFetch
│   Produces: problem_brief, literature_map, hypothesis_card, result_report
│
├── Codex -p (Engineer Agent)       ← agents/engineer/AGENTS.md
...
│  ├── Dispatch → Researcher (Codex -p, 15 turns max)
...
```
agents/
├── researcher/AGENTS.md     # Researcher role instructions
├── engineer/AGENTS.md       # Engineer role instructions
└── orchestrator/AGENTS.md   # Orchestrator role instructions
